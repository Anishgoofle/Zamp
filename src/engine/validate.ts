 ...
 * construction (see ../../decisions.md): unique table ids, unique column ids per
 * table, resolvable foreign keys. Returns every problem found. Callers run this
 * on import; `diff`/`apply` assume it has passed.
 */
