 ...
 *
 * The engine keeps its own copy, since it writes the same numbers into hazard
 * messages and can't import from app/. Two small copies across a boundary that
 * exists on purpose beat one shared module that breaks it.
 */
